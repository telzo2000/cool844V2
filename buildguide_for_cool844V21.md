...
# 1　部品の確認
本品はスイッチプレート、ミドルプレート（２種３枚）、PCB、ボトムプレート大、ボトムプレート小（３枚）、USBタイプC端子付きケーブルで構成されています。<br>
<br>
次のものは各自でご用意ください。<br>
ダイオード44個、スイッチソケット44個、リセットスイッチ１個、pro micro１個、スプリングピンヘッダ（マックエイトコンスルー）２個、
M2ねじ８mm７本、M2ねじ４mm３本、M2ねじ12mm4本、M2スペーサー6mm７本、スタビライザー２U ３個、USBタイプC基板１個の他、<br>
お気に入りのキーキャップセットとなります。<br>
<br>
注意<br>
M2ねじ12mmが入手できない時は、15mmでも代用できますが、
その際は、ワッシャーを使用ください。
ねじ込まれる長さを調整してください。
...
<br>
# ６　ドーターボードの作成
付属のUSBタイプC端子付きケーブルを必要な長さに切ります。<br>
![](img/img00030.jpg)
...
この時、USBタイプC基板の個体差の関係で、幅が大きく、ミドルプレート下に鑑賞する場合、基板の両端部をヤスリで削ってください。<br>
次の画像を参考にしてください。
...
![](img/img00048.jpg)
![](img/img00049.jpg)
M2ねじ8mmをスイッチプレート側から差し込んで、PCB側にM2スペーサーで固定します。<br>
<br>
# 9　キースイッチの装着
...
# 13　60%汎用ケースへの換装
ケースはcool844と同じように、GH60系60％キーボードケースを使うことを前提になっています。
...
令和３年9月11日時点では、私個人で所有している３つのケースで使うことができています。<br>
ケースごとに若干個体差があるようで、端子挿入口の高さや、
本体内部のねじ穴位置が少し違います。<br>
その際は、ネジでの固定位置を減らすことや、USBタイプC基板の設置する高さの修正をしてください。<br>
...
![](img/img00074.jpg)
ネジの固定ができましたら、上部を汎用ケースに乗せて、上部にあるネジ７箇所で固定してください。完成です。<br>
![](img/img00065.jpg)